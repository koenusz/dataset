...
public class VaadinUtils {
    ...
    public static <T extends Component> T findById(HasComponents root, Class<T> returnType) {
        return findById(root, returnType.getSimpleName(), returnType);
    }
